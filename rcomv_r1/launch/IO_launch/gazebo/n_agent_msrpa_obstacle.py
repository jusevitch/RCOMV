...
for i in range(number_of_trucks):
    truck_array[i].args = args_string + truck_array[i].name + " -x " + str(round(truck_radius*cos(i*2*pi/number_of_trucks),2)) + " -y " + str(round(truck_radius*sin(i*2*pi/number_of_trucks),2))
